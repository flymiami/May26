...
const ART = [
  ...
  {n:10, slug:"its-so-miami", title:"It's so Miami", theme:"PRIDE",
   medium:"Tiny resin flamingos", size:"30 × 30 in", price:5000, loc:"16th Floor · Pride side",
...
function answer(qRaw){
  ...
  if(/price|cost|buy|sale|how much|purchase/.test(q)){
    ...
    return `Prices run <b>$1,000 to $10,000</b>. Tap any artwork for its price, or ask "how much is Messi?"`;
  }
